    ...
    <main>
        <section class="A-register">
            <div class="A_content-register">
                <h2 class="A_headerText-register">REGISTER NOW</h2>
                <p>live the real experience !</p>
            </div>
            <div class="img_back-register"></div>
        </section>

        <form class="form-register" method="POST" name="form-work" action="logica/registrar.php">
            <header>
            ...
            <div class="save-zone">
                ...
                <a class="guide-register" href="registerGuide.php">Join us as a guide!</a>
            </div>
        </form>
    </main>
</body>
